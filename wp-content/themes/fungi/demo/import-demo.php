...
function themesflat_import_files() {
	return array(
		array(
			...
			'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the MailChimp form.', 'fungi' ),
			'preview_url'                => esc_url( THEMESFLAT_PROTOCOL . '://fungiwp.themesflat.co/' ),
		),
	);
}
...
function themesflat_after_import_setup() {
	...
	$main_menu   = get_term_by( 'name', 'Menu One Page', 'nav_menu' );
