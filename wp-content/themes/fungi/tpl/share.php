...
<div class="<?php echo esc_attr( $wrapper_class ) ?>">
    <label class="themesflat-share-label"><?php esc_html_e( 'Share:', 'fungi' ) ?></label>
		...
		foreach ( $social_share as $key ) {
			...
			switch ( $key ) {
				...
				case 'whatsapp':
					...
					$title        = esc_html__( 'Whats App', 'fungi' );
					$attributes[] = 'target="_blank"';
					break;
			}
