...
$links = paginate_links( array(
	...
	'prev_text' =>  __( '<i class="fal fa-long-arrow-left"></i>', 'fungi' ),
	'next_text' =>  __( '<i class="fal fa-long-arrow-right"></i>', 'fungi' ),
) );
...
$next_link     = get_next_posts_link( esc_html__( 'Next', 'fungi' ) );
$prev_link     = get_previous_posts_link( esc_html__( 'Previous', 'fungi' ) );
$loadmore_text = apply_filters( 'themesflat/template/loadmore_text', esc_html__( 'Load More', 'fungi' ) );
