...
if ( class_exists( 'WP_Customize_Control' ) ) {
	...
	class themesflat_Typography extends WP_Customize_Control {
		...
		public function render_content() {
			$this->titles = array(
				'100'        => esc_html__( 'Thin 100', 'fungi' ),
				'100italic'  => esc_html__( 'Thin 100 italic', 'fungi' ),
				'200'        => esc_html__( 'Extra-light 200', 'fungi' ),
				'200italic'  => esc_html__( 'Extra-light 200 italic', 'fungi' ),
				'300'        => esc_html__( 'Light 300', 'fungi' ),
				'300italic'  => esc_html__( 'Light 300 italic', 'fungi' ),
				'400'        => esc_html__( 'Normal 400', 'fungi' ),
				'400italic'  => esc_html__( 'Normal 400 italic', 'fungi' ),
				'regular'    => esc_html__( 'Normal 400', 'fungi' ),
				'italic'     => esc_html__( 'Normal 400 italic', 'fungi' ),
				'500'        => esc_html__( 'Medium 500', 'fungi' ),
				'500italic'  => esc_html__( 'Medium 500 italic', 'fungi' ),
				'600'        => esc_html__( 'Semi-bold 600', 'fungi' ),
				'600italic'  => esc_html__( 'Semi-bold 600 italic', 'fungi' ),
				'700'        => esc_html__( 'Bold 700', 'fungi' ),
				'700italic'  => esc_html__( 'Bold 700 italic', 'fungi' ),
				'800'        => esc_html__( 'Extra-bold 800', 'fungi' ),
				'800italic'  => esc_html__( 'Extra-bold 800 italic', 'fungi' ),
				'900'        => esc_html__( 'Ultra-bold 900', 'fungi' ),
				'900itallic' => esc_html__( 'Ultra-bold 900 italic', 'fungi' )
			);

			$this->titles_subsets = array(
				"cyrillic-ext" => esc_html__( "Cyrillic Extended", 'fungi' ),
				"greek"        => esc_html__( "Greek", 'fungi' ),
				"greek-ext"    => esc_html__( "Greek Extended", 'fungi' ),
				"latin-ext"    => esc_html__( "Latin Extended", 'fungi' ),
				"cyrillic"     => esc_html__( "Cyrillic", 'fungi' ),
				"vietnamese"   => esc_html__( "Vietnamese", 'fungi' ),
				"latin"        => esc_html__( "Latin", 'fungi' )
			);
            ...
            <div class="themesflat-options-control-inputs">
				<?php if ( in_array( 'family', $this->fields ) ): ?>
                    <div class="themesflat-options-control-chosen themesflat-typography-group typography-font">
                        <div class="themesflat-options-control-title customize-control-title">
                            <label for="<?php themesflat_esc_attr( $name ) ?>-family"><?php esc_html_e( 'Font Family', 'fungi' ) ?></label>
                        </div>
                        <div class="themesflat-options-control-inputs">
                            <select name="<?php themesflat_esc_attr( $name ) ?>[family]"
                                    id="<?php themesflat_esc_attr( $name ) ?>-family" class="select-choosen">
                                <optgroup label="<?php themesflat_esc_html( 'Google Fonts', 'fungi' ) ?>">
                ...
                <div class="themesflat-options-control-chosen themesflat-typography-group typography-style">
                    <div class="themesflat-options-control-title customize-control-title">
                        <label><?php esc_html_e( 'Font Weight & Style', 'fungi' ) ?></label>
                    </div>
                    <div class="themesflat-options-control-inputs">
                        <label>
                ...
                <div class="themesflat-options-control typography-subsets themesflat-options-control-switcher active">
                    <div class="themesflat-options-control-title customize-control-title">
                        <label><?php esc_html_e( 'Font subsets', 'fungi' ) ?></label>
                    </div>
                    <div class="themesflat-options-control-inputs">
				...
				<?php if ( in_array( 'size', $this->fields ) ): ?>
                    <div class="themesflat-typography-group typography-size">
                        <div class="themesflat-options-control-title customize-control-title">
                            <label for="<?php themesflat_esc_attr( $name ) ?>-size"><?php esc_html_e( 'Font Size (px)', 'fungi' ) ?></label>
                        </div>
                        <div class="themesflat-options-control-inputs">
				...
				<?php if ( in_array( 'line_height', $this->fields ) ): ?>
                    <div class="themesflat-typography-group typography-line_height">
                        <div class="themesflat-options-control-title customize-control-title">
                            <label for="<?php themesflat_esc_attr( $name ) ?>-line_height"><?php esc_html_e( 'Line height ( ex: 25px or 1.8 or 150% )', 'fungi' ) ?></label>
                        </div>
                        <div class="themesflat-options-control-inputs">
				...
				<?php if ( in_array( 'letter_spacing', $this->fields ) ): ?>
                    <div class="themesflat-typography-group typography-letter_spacing">
                        <div class="themesflat-options-control-title customize-control-title">
                            <label for="<?php themesflat_esc_attr( $name ) ?>-letter_spacing"><?php esc_html_e( 'Letter Spacing ( Value in px or em )', 'fungi' ) ?></label>
                        </div>
                        <div class="themesflat-options-control-inputs">
				...
				<?php if ( in_array( 'color', $this->fields ) ): ?>
                    <div class="themesflat-typography-group themesflat-options-control-color-picker typography-color">
                        <div class="themesflat-options-control-title customize-control-title">
                            <label><?php esc_html_e( 'Font Color', 'fungi' ) ?></label>
                        </div>
                        <div class="themesflat-options-control-inputs">
