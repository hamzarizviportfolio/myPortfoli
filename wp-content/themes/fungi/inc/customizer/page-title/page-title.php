...
$wp_customize->add_control( new themesflat_Checkbox( $wp_customize,
		...
		array(
			'type'     => 'checkbox',
			'label'    => esc_html__( 'Heading ( OFF | ON )', 'fungi' ),
...
$wp_customize->add_control( new themesflat_Info( $wp_customize, 'page-title-style', array(
		'label'    => esc_html__( 'Page Title Style', 'fungi' ),
		'section'  => 'section_page_title',
...
$wp_customize->add_control(
	...
	array(
		...
		'label'    => esc_html__( 'Page Title Style', 'fungi' ),
		'choices'  => array(
			'inline'  => esc_html__( 'Inline Heading & Breadcrumbs', 'fungi' ),
			'default' => esc_html__( 'Default', 'fungi' ),
			'video'   => esc_html__( 'Video', 'fungi' )
		),
	)
);
...
$wp_customize->add_control(
	...
	array(
		...
		'section'  => 'section_page_title',
		'priority' => 20,
		'label'    => esc_html__( 'Page Title Alignment', 'fungi' ),
		'choices'  => array(
			'text-left'   => esc_html__( 'Left', 'fungi' ),
			'text-center' => esc_html__( 'Center', 'fungi' ),
			'text-end'    => esc_html__( 'Right', 'fungi' )
		),
	)
);
...
$wp_customize->add_control(
	new WP_Customize_Image_Control(
		...
		'page_title_background_image',
		array(
			'label'    => esc_html__( 'Upload Background Image', 'fungi' ),
			'type'     => 'image',
			'section'  => 'section_page_title',
			'priority' => 25,
		)
...
$wp_customize->add_control(
	...
	array(
		...
		'section'  => 'section_page_title',
		'priority' => 30,
		'label'    => esc_html__( 'Page Title Image Size', 'fungi' ),
		'choices'  => array(
			'auto'    => esc_html__( 'Original', 'fungi' ),
			'contain' => esc_html__( 'Fit to Screen', 'fungi' ),
			'cover'   => esc_html__( 'Fill Screen', 'fungi' )
		),
	)
);

$wp_customize->add_setting(
	'page_title_bg_fix_enabled',
	array(
		'sanitize_callback' => 'themesflat_sanitize_checkbox',
		'default'           => themesflat_customize_default( 'page_title_bg_fix_enabled' ),
	)
);
$wp_customize->add_control( new themesflat_Checkbox( $wp_customize,
		'page_title_bg_fix_enabled',
		array(
			'type'     => 'checkbox',
			'label'    => esc_html__( 'Background Parallax ( OFF | ON )', 'fungi' ),
			'section'  => 'section_page_title',
			'priority' => 33,
		) )
);
...
$wp_customize->add_control(
	...
	array(
		'type'     => 'text',
		'label'    => esc_html__( 'Page Title Background Video URL', 'fungi' ),
		'section'  => 'section_page_title',
		'priority' => 35
	)
);
...
$wp_customize->add_control( new themesflat_ColorOverlay(
		...
		'page_title_background_color',
		array(
			'label'    => esc_html__( 'Background Color', 'fungi' ),
			'section'  => 'section_page_title',
			'priority' => 40
		)
	)
...
$wp_customize->add_control( new themesflat_BoxControls( $wp_customize,
		'page_title_controls',
		array(
			'label'    => esc_html__( 'Page Title Controls (px)', 'fungi' ),
			'section'  => 'section_page_title',
			'type'     => 'box-controls',
			'priority' => 50
		) )
...
$wp_customize->add_control( new themesflat_BoxControls( $wp_customize,
		'page_title_controls_mobile',
		array(
			'label'    => esc_html__( 'Page Title Controls Mobile (px)', 'fungi' ),
			'section'  => 'section_page_title',
			'type'     => 'box-controls',
			'priority' => 55
		) )
