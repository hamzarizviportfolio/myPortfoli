...
$wp_customize->add_control(
	...
	array(
		'type'     => 'text',
		'label'    => esc_html__( 'Customize Blog Featured Title', 'fungi' ),
...
$wp_customize->add_control( new themesflat_Checkbox( $wp_customize,
		...
		array(
			'type'     => 'checkbox',
			'label'    => esc_html__( 'Post Navigator ( OFF | ON )', 'fungi' ),
			'section'  => 'section_content_blog_single',
			'priority' => 4
		) )
);
...
$wp_customize->add_control( new themesflat_Checkbox( $wp_customize,
		...
		array(
			'type'     => 'checkbox',
			'label'    => esc_html__( 'Entry Footer ( OFF | ON )', 'fungi' ),
			'section'  => 'section_content_blog_single',
			'priority' => 5,
		) )
);
...
$wp_customize->add_control( new themesflat_Checkbox( $wp_customize,
		...
		array(
			'type'     => 'checkbox',
			'label'    => esc_html__( 'Related Posts ( OFF | ON )', 'fungi' ),
			'section'  => 'section_content_blog_single',
			'priority' => 6
		) )
);
...
$wp_customize->add_control(
	...
	array(
		...
		'section'         => 'section_content_blog_single',
		'priority'        => 7,
		'label'           => esc_html__( 'Related Posts Style', 'fungi' ),
		'choices'         => array(
...
$wp_customize->add_control(
	...
	array(
		...
		'section'         => 'section_content_blog_single',
		'priority'        => 8,
		'label'           => esc_html__( 'Columns Of Related Posts', 'fungi' ),
		'choices'         => array(
