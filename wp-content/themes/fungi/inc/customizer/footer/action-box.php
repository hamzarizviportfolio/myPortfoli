...
$wp_customize->add_control( new themesflat_Checkbox( $wp_customize,
		...
		array(
			'type'     => 'checkbox',
			'label'    => esc_html__( 'Action Box ( OFF | ON )', 'fungi' ),
...
$wp_customize->add_control(
	...
	array(
		...
		'section'         => 'section_action_box',
		'priority'        => 2,
		'label'           => esc_html__( 'Styles', 'fungi' ),
		'choices'         => array(
			'style1' => esc_html__( 'Style 1', 'fungi' ),
			'style2' => esc_html__( 'Style 2', 'fungi' ),
		),
...
$wp_customize->add_control(
	...
	array(
		'type'            => 'textarea',
		'label'           => esc_html__( 'Heading Action Box', 'fungi' ),
		'section'         => 'section_action_box',
		'priority'        => 3,
		'active_callback' => function () use ( $wp_customize ) {
			return 1 === $wp_customize->get_setting( 'show_action_box' )->value();
...
$wp_customize->add_control(
	...
	array(
		'type'            => 'textarea',
		'label'           => esc_html__( 'Text Action Box', 'fungi' ),
		'section'         => 'section_action_box',
		'priority'        => 4,
		'active_callback' => function () use ( $wp_customize ) {
...
$wp_customize->add_control(
	...
	array(
		'type'            => 'textarea',
		'section'         => 'section_action_box',
		'label'           => esc_html__( 'Content Right', 'fungi' ),
		'description'     => esc_html__( 'shorcode or button link ex: [mc4wp_form id="237"] or <a href="#" class="themesflat-button">Read More</a>', 'fungi' ),
		'priority'        => 5,
		'active_callback' => function () use ( $wp_customize ) {
			return 1 === $wp_customize->get_setting( 'show_action_box' )->value();
		},
...
$wp_customize->add_control( new themesflat_BoxControls( $wp_customize,
		'action_box_controls',
		array(
			'label'           => esc_html__( 'Box Controls (px)', 'fungi' ),
			'section'         => 'section_action_box',
			'type'            => 'box-controls',
			'priority'        => 6,
			'active_callback' => function () use ( $wp_customize ) {
