...
$wp_customize->add_control( new themesflat_Checkbox( $wp_customize,
		...
		array(
			'type'     => 'checkbox',
			'label'    => esc_html__( 'Bottom ( OFF | ON )', 'fungi' ),
...
$wp_customize->add_control( new themesflat_Checkbox( $wp_customize,
		...
		array(
			'type'     => 'checkbox',
			'label'    => esc_html__( 'Divider ( OFF | ON )', 'fungi' ),
			'section'  => 'section_bottom',
			'priority' => 2
		) )
);
...
$wp_customize->add_control(
	...
	array(
		...
		'choices'         => array(
			'bottom-style1' => esc_html__( 'Style 1', 'fungi' ),
			'bottom-style2' => esc_html__( 'Style 2', 'fungi' ),
			'bottom-style3' => esc_html__( 'Style 3', 'fungi' ),
		),
...
$wp_customize->add_control(
	new WP_Customize_Image_Control(
		...
		'bottom_logo',
		array(
			'label'           => esc_html__( 'Upload Your Logo', 'fungi' ),
			'type'            => 'image',
			'section'         => 'section_bottom',
			'priority'        => 4,
			'active_callback' => function () use ( $wp_customize ) {
...
$wp_customize->add_control(
	'footer_copyright',
	array(
		'label'           => esc_html__( 'Copyright', 'fungi' ),
		'section'         => 'section_bottom',
		'type'            => 'textarea',
		'priority'        => 5,
		'active_callback' => function () use ( $wp_customize ) {
