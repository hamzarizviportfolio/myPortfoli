...
$wp_customize->add_control( new themesflat_ColorOverlay(
        ...
        array(
            ...
            'description' => esc_html__( ' Opacity =1 for Background Color', 'fungi' ),
            'section'     => 'color_header',
            'priority'    => 5
        )
    )
...
$wp_customize->add_control( new themesflat_ColorOverlay(
        ...
        'header_color_main_nav',
        array(
            'label'    => esc_html__( 'Color Navigation', 'fungi' ),
            'section'  => 'color_header',
            'priority' => 10
        )
    )
...
$wp_customize->add_control( new themesflat_ColorOverlay(
        ...
        'header_color_hover_main_nav',
        array(
            'label'    => esc_html__( 'Color Hover Navigation', 'fungi' ),
            'section'  => 'color_header',
            'priority' => 15
        )
    )
...
$wp_customize->add_control( new themesflat_Info( $wp_customize, 'label_header_color_submenu', array(
        'label'    => esc_html__( 'Sub Menu', 'fungi' ),
        'section'  => 'color_header',
        'settings' => 'themesflat_options[info]',
        'priority' => 50
    ) )
...
$wp_customize->add_control(
    new themesflat_ColorOverlay(
        ...
        'sub_nav_color',
        array(
            'label'    => esc_html__( 'Regular', 'fungi' ),
            'section'  => 'color_header',
            'priority' => 55
        )
    )
...
$wp_customize->add_control(
    new themesflat_ColorOverlay(
        ...
        'sub_nav_color_hover',
        array(
            'label'    => esc_html__( 'Hover & Active', 'fungi' ),
            'section'  => 'color_header',
            'priority' => 56
        )
    )
...
$wp_customize->add_control(
    new themesflat_ColorOverlay(
        ...
        'sub_nav_border_color',
        array(
            'label'    => esc_html__( 'Border Line', 'fungi' ),
            'section'  => 'color_header',
            'priority' => 59
        )
    )
