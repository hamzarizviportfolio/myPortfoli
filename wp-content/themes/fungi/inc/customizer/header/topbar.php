...
$wp_customize->add_control( new themesflat_Checkbox( $wp_customize,
        ...
        array(
            'type'     => 'checkbox',
            'label'    => esc_html__( 'Enable Topbar ( OFF | ON )', 'fungi' ),
...
$wp_customize->add_control( new themesflat_Checkbox( $wp_customize,
		...
		array(
			'type'     => 'checkbox',
			'label'    => esc_html__( 'Social ( OFF | ON )', 'fungi' ),
			'section'  => 'section_topbar',
			'priority' => 10,
...
$wp_customize->add_control( new themesflat_Checkbox( $wp_customize,
		...
		array(
			'type'     => 'checkbox',
			'label'    => esc_html__( 'Info Left ( OFF | ON )', 'fungi' ),
			'section'  => 'section_topbar',
			'priority' => 15,
...
$wp_customize->add_control(
    ...
    array(
        'type'            => 'text',
        'label'           => esc_html__( 'Enter info Left Topbar', 'fungi' ),
        'section'         => 'section_topbar',
        'priority'        => 20,
...
$wp_customize->add_control( new themesflat_Checkbox( $wp_customize,
        ...
        array(
            'type'     => 'checkbox',
            'label'    => esc_html__( 'Info Right ( OFF | ON )', 'fungi' ),
            'section'  => 'section_topbar',
            'priority' => 25,
...
$wp_customize->add_control(
    ...
    array(
        'type'            => 'text',
        'label'           => esc_html__( 'Enter info Right  Topbar', 'fungi' ),
        'section'         => 'section_topbar',
        'priority'        => 30,
        'active_callback' => function () use ( $wp_customize ) {
