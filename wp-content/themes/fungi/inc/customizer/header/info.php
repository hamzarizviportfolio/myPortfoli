...
$wp_customize->add_control(
	'header_info_email',
	array(
		'label'    => esc_html__( 'email Number', 'fungi' ),
		'section'  => 'section_info',
		'type'     => 'text',
		'priority' => 15
	)
...
$wp_customize->add_control(
	'header_info_time',
	array(
		'label'    => esc_html__( 'Phone Number', 'fungi' ),
		'section'  => 'section_info',
		'type'     => 'text',
		'priority' => 25
	)
