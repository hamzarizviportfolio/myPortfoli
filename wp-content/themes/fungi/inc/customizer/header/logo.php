...
$wp_customize->add_control(
	new WP_Customize_Image_Control(
		...
		array(
            ...
            Site Title default in General', 'fungi' ),
			'type'        => 'image',
...
$wp_customize->add_control(
	new WP_Customize_Image_Control(
		...
		'site_logo_sticky',
		array(
			'label'       => esc_html__( 'Upload Your Logo Sticky', 'fungi' ),
			'description' => esc_html__( 'If there is no sticky logo. The site logo will be displayed', 'fungi' ),
			'type'        => 'image',
			'section'     => 'section_logo',
			'priority'    => 5,
		)
...
$wp_customize->add_control(
	new WP_Customize_Image_Control(
		...
		'site_logo_mobile',
		array(
			'label'       => esc_html__( 'Upload Your Logo On Mobile', 'fungi' ),
			'description' => esc_html__( 'If you don\'t display logo please remove it your website display 
            Site Title default in General', 'fungi' ),
			'type'        => 'image',
			'section'     => 'section_logo',
