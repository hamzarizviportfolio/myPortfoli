...
$wp_customize->add_control( new themesflat_Info( $wp_customize, 'header-mobile', array(
		'label'    => esc_html__( 'Header Mobile', 'fungi' ),
...
$wp_customize->add_control( new themesflat_Checkbox( $wp_customize,
		...
		array(
			'type'     => 'checkbox',
			'label'    => esc_html__( 'Enable Search Box ( OFF | ON )', 'fungi' ),
			'section'  => 'section_header_mobile',
			'priority' => 3,
...
$wp_customize->add_control( new themesflat_Checkbox( $wp_customize,
		...
		array(
			'type'     => 'checkbox',
			'label'    => esc_html__( 'Enable ( OFF | ON )', 'fungi' ),
			'section'  => 'section_header_mobile',
			'priority' => 11,
...
$wp_customize->add_control( new themesflat_Checkbox( $wp_customize,
		...
		array(
			'type'     => 'checkbox',
			'label'    => esc_html__( 'Menu ( OFF | ON )', 'fungi' ),
			'section'  => 'section_header_mobile',
			'priority' => 12,
