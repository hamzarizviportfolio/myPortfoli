...
function themesflat_custom_styles( $custom ) {
	...
	if ( $blog_post_meta_fonts_family != '' ) {
		$custom .= "article .post-meta .item-meta a,article .post-meta .item-meta span { font-family:" . $blog_post_meta_fonts_family . ";}" . "\n";
	}
	// font weight
	if ( $blog_post_meta_font_weight != '' ) {
		$custom .= "article .post-meta .item-meta a,article .post-meta .item-meta span { font-weight:" . $blog_post_meta_font_weight . ";}" . "\n";
	}
	// font style
	if ( isset( $blog_post_meta_font_style ) ) {
		$custom .= "article .post-meta .item-meta a,article .post-meta .item-meta span { font-style:" . $blog_post_meta_font_style . "; }" . "\n";
	}
	// font size
	if ( $blog_post_meta_fonts_size != '' ) {
		$custom .= "article .post-meta .item-meta a,article .post-meta .item-meta span { font-size:" . intval( $blog_post_meta_fonts_size ) . "px;}" . "\n";
	}
	// line height
	if ( $blog_post_meta_line_height != '' ) {
		$custom .= "article .post-meta .item-meta a,article .post-meta .item-meta span { line-height:" . $blog_post_meta_line_height . ";}" . "\n";
	}
	// letter spacing
	if ( $blog_post_meta_letter_spacing != '' ) {
		$custom .= "article .post-meta .item-meta a,article .post-meta .item-meta span { letter-spacing:" . $blog_post_meta_letter_spacing . ";}" . "\n";
	}
	...
	if ( $blog_single_comment_title_fonts_family != '' ) {
		$custom .= ".comment-title, .comment-reply-title, .comment-reply-title a,.comment-list-wrap .comment-title { font-family:" . $blog_single_comment_title_fonts_family . ";}" . "\n";
	}
	// font weight
	if ( $blog_single_comment_title_font_weight != '' ) {
		$custom .= ".comment-title, .comment-reply-title, .comment-reply-title a,.comment-list-wrap .comment-title { font-weight:" . $blog_single_comment_title_font_weight . ";}" . "\n";
	}
	// font style
	if ( isset( $blog_single_comment_title_font_style ) ) {
		$custom .= ".comment-title, .comment-reply-title, .comment-reply-title a,.comment-list-wrap .comment-title { font-style:" . $blog_single_comment_title_font_style . "; }" . "\n";
	}
	// font size
	if ( $blog_single_comment_title_fonts_size != '' ) {
		$custom .= ".comment-title, .comment-reply-title,.comment-list-wrap .comment-title { font-size:" . intval( $blog_single_comment_title_fonts_size ) . "px;}" . "\n";
	}
	// line height
	if ( $blog_single_comment_title_line_height != '' ) {
		$custom .= ".comment-title, .comment-reply-title, .comment-reply-title a,.comment-list-wrap .comment-title { line-height:" . $blog_single_comment_title_line_height . ";}" . "\n";
	}
	// letter spacing
	if ( $blog_single_comment_title_letter_spacing != '' ) {
		$custom .= ".comment-title, .comment-reply-title, .comment-reply-title a,.comment-list-wrap .comment-title { letter-spacing:" . $blog_single_comment_title_letter_spacing . ";}" . "\n";
	}
	...
	$sub_title_fonts_         = themesflat_get_json( 'typography_sub_title' );
	$sub_title_fonts_family   = $sub_title_fonts_['family'];
	$sub_title_fonts_size     = $sub_title_fonts_['size'];
	$sub_title_line_height    = $sub_title_fonts_['line_height'];
	$sub_title_letter_spacing = $sub_title_fonts_['letter_spacing'];
	$breadcrumb_style         = themesflat_font_style( $sub_title_fonts_['style'] );
	$sub_title_font_weight    = $breadcrumb_style[0];
	$sub_title_font_style     = $breadcrumb_style[1];

	// font family
	if ( $sub_title_fonts_family != '' ) {
		$custom .= ".page-title .page-sub-title { font-family:" . $sub_title_fonts_family . ";}" . "\n";
	}
	// font weight
	if ( $sub_title_font_weight != '' ) {
		$custom .= ".page-title .page-sub-title { font-weight:" . $sub_title_font_weight . ";}" . "\n";
	}
	// font style
	if ( isset( $sub_title_font_style ) ) {
		$custom .= ".page-title .page-sub-title { font-style:" . $sub_title_font_style . "; }" . "\n";
	}
	// font size
	if ( $sub_title_fonts_size != '' ) {
		$custom .= ".page-title .page-sub-title { font-size:" . intval( $sub_title_fonts_size ) . "px;}" . "\n";
	}
	// line height
	if ( $sub_title_line_height != '' ) {
		$custom .= ".page-title .page-sub-title { line-height:" . $sub_title_line_height . ";}" . "\n";
	}
	// letter spacing
	if ( $sub_title_letter_spacing != '' ) {
		$custom .= ".page-title .page-sub-title { letter-spacing:" . $sub_title_letter_spacing . ";}" . "\n";
	}
	...
	$content_controls_mobile = themesflat_decode( themesflat_get_opt( 'content_controls_mobile' ) );
	themesflat_render_box_position_tablet( "#themesflat-content", $content_controls_mobile, $break_point_1 );
	...
	if ( themesflat_get_opt( 'header_backgroundcolor_sticky' ) != '' ) {
		$custom .= ".sticky-area-wrap.sticky .inner-header { background-color:" . esc_attr( themesflat_get_opt( 'header_backgroundcolor_sticky' ) ) . "  !important;} " . "\n";
	}
	...
	if ( $header_backgroundcolor != '' ) {
		$custom .= "#header,header.header-style-01 .sticky-area-wrap .inner-header,header.header-style-02 .sticky-area-wrap .inner-header .header-wrap,.page-sidebar .page-sidebar-nav  { background-color:" . esc_attr( $header_backgroundcolor ) . "; !important}" . "\n";
	}

	$header_backgroundcolor_sticky = themesflat_get_opt( 'header_backgroundcolor_sticky' );
	if ( $header_backgroundcolor_sticky != '' ) {
		$custom .= ".header_sticky .header-sticky ,header.header-style-01 .sticky-area-wrap.sticky .inner-header,header.header-style-02 .sticky-area-wrap.sticky .inner-header .header-wrap { background-color:" . esc_attr( $header_backgroundcolor_sticky ) . " !important;}" . "\n";
	}
	//Nav
	...
	if ( $header_color_main_nav != '' ) {
		...
		$custom .= 'header.header-style-01 .sticky-area-wrap .inner-header #mainnav > ul > li > a,header.header-style-02 .sticky-area-wrap .inner-header #mainnav > ul > li > a { color:' . esc_attr( $header_color_main_nav ) . "  ;}\n";
	}

	$header_color_hover_main_nav = themesflat_get_opt( 'header_color_hover_main_nav' );
	if ( $header_color_hover_main_nav != '' ) {
		$custom .= '.sticky-area-wrap .inner-header #mainnav > ul > li.current-menu-item > a,.sticky-area-wrap .inner-header #mainnav > ul > li > a:hover,.sticky-area-wrap .inner-header #mainnav > ul > li.active > a,header.header-style-01 .sticky-area-wrap .inner-header #mainnav > ul > li.current-menu-item > a,header.header-style-01 .sticky-area-wrap .inner-header #mainnav > ul > li > a:hover,header.header-style-01 .sticky-area-wrap .inner-header #mainnav > ul > li.active > a,header.header-style-02 .sticky-area-wrap .inner-header #mainnav > ul > li.current-menu-item > a,header.header-style-02 .sticky-area-wrap .inner-header #mainnav > ul > li > a:hover,header.header-style-02 .sticky-area-wrap .inner-header #mainnav > ul > li.active > a { color:' . esc_attr( $header_color_hover_main_nav ) . "  ;}\n";
	}
	...
	if ( $header_sticky_color_main_nav != '' ) {
		...
		$custom .= 'header.header-style-01 .sticky-area-wrap.sticky .inner-header #mainnav > ul > li > a,header.header-style-02 .sticky-area-wrap.sticky .inner-header #mainnav > ul > li > a { color:' . esc_attr( $header_sticky_color_main_nav ) . "  ;}\n";
	}
	...
	if ( $header_sticky_color_hover_main_nav != '' ) {
		$custom .= '.sticky-area-wrap.sticky .inner-header #mainnav > ul > li.current-menu-item > a, .sticky-area-wrap.sticky .inner-header #mainnav > ul > li > a:hover,.sticky-area-wrap.sticky .inner-header #mainnav > ul > li.active > a,header.header-style-01 sticky-area-wrap.sticky .inner-header #mainnav > ul > li.current-menu-item > a,header.header-style-01 .sticky-area-wrap.sticky .inner-header #mainnav > ul > li > a:hover,header.header-style-01 .sticky-area-wrap.sticky .inner-header #mainnav > ul > li.active > a,header.header-style-02 .sticky-area-wrap.sticky .inner-header #mainnav > ul > li.current-menu-item > a,header.header-style-02 .sticky-area-wrap.sticky .inner-header #mainnav > ul > li > a:hover,header.header-style-02 .sticky-area-wrap.sticky .inner-header #mainnav > ul > li.active > a {color:' . esc_attr( $header_sticky_color_hover_main_nav ) . " ;}\n";
	}

	$header_height = themesflat_get_opt( 'header_height' );
	if ( $header_height != '' ) {
		$root .= ' --theme-height-header:' . esc_attr( $header_height ) . "px;\n";
	}

	$header_height_sticky = themesflat_get_opt( 'header_height_sticky' );
	if ( $header_height != '' ) {
		$root .= ' --theme-height-header-sticky:' . esc_attr( $header_height_sticky ) . "px;\n";
	}
	...
	if ( $sub_nav_color_hover != '' ) {
		...
		$custom .= " #mainnav ul.sub-menu > li > a:before { background:" . esc_attr( $sub_nav_color_hover ) . ";}" . "\n";
	}
	...
	if ( ! empty( themesflat_get_opt( 'sub_title_color' ) ) ) {
		$custom .= ".page-title .page-sub-title {color:" . themesflat_get_opt( 'sub_title_color' ) . ";}" . "\n";
	}
	...
	if ( $body_text != '' ) {
		...
		//border bodycolor
		$custom .= "ul.iconlist li.circle:before { background-color:" . esc_attr( $body_text ) . "}" . "\n";
	}
	...
	if ( $primary_color != '' ) {
		...
		$custom .= "article .entry-title a, .item article .entry-title a, .widget.widget_categories ul li a, .widget.widget_archive ul li a, .widget.widget_pages ul li a, .widget.widget_block .wp-block-archives li a, .widget .wp-block-categories li a, .tags-links a, .logged-in-as a, .blog-single .entry-footer .tags-links a,.posts-navigation .nav-links a:hover .title { color:" . esc_attr( $primary_color ) . ";}" . "\n";

		//Sidebar
		$custom .= ".comment-list .comement_reply a:hover, .sidebar .widget_recent_comments ul li, .sidebar .widget.widget_block ol.wp-block-latest-comments li, .sidebar .widget.widget_recent_comments ul li, .sidebar .widget.widget_rss ul li, .sidebar .widget.widget_block ol.wp-block-latest-comments li{ color:" . esc_attr( $primary_color ) . "!important;}" . "\n";
	...
	if ( $accent_color != '' ) {
		$custom .= "h1, h2, h3, h4, h5, h6,.posts-navigation .nav-links .title { color:" . esc_attr( $accent_color ) . ";}" . "\n";
