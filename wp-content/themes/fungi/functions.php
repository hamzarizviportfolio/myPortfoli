...
if ( ! function_exists( 'themesflat_setup' ) ) :
	...
	function themesflat_setup() {
		 ...
		 * to change 'fungi' to the name of your theme in all the template files
		 */
		load_theme_textdomain( 'fungi', THEMESFLAT_DIR . '/languages' );
		...
		register_nav_menus( array(
			'primary' => esc_html__( 'Primary Menu', 'fungi' ),
			//'topbar'  => esc_html__( 'Topbar Menu', 'fungi' ),
			'bottom'  => esc_html__( 'Bottom Menu', 'fungi' )
		) );
...
function themesflat_widgets_init() {
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar Blog', 'fungi' ),
		'id'            => 'blog-sidebar',
		'description'   => esc_html__( 'Add widgets here to appear in your sidebar Blog Sidebar.', 'fungi' ),
...
function themesflat_enqueue_bootstrap() {
	...
	wp_enqueue_script( 'bootstrap-bundle', THEMESFLAT_LINK . 'js/bootstrap.js', array() );
}
...
function themesflat_scripts() {
	...
	wp_enqueue_style( 'pe-icon', THEMESFLAT_LINK . 'css/pe-icon-7-stroke.css' );
	wp_enqueue_style( 'pe-helper', THEMESFLAT_LINK . 'css/pe-helper.css' );
	wp_enqueue_style( 'bootstrap-icon', THEMESFLAT_LINK . 'css/bootstrap-icons.css' );
	...
	wp_enqueue_style( 'aos-css', THEMESFLAT_LINK . 'css/aos.css' );
	...
	wp_enqueue_script( 'hc-sticky', THEMESFLAT_LINK . 'vendor/hc-sticky/hc-sticky.js', array( 'jquery' ), '1.8.0', true );
	// Load the html5 shiv..
	...
	wp_enqueue_script( 'aos', THEMESFLAT_LINK . 'js/aos.js', array( 'jquery' ), '2.6.0', true );
	// wp_enqueue_script( 'parallax-animation-min', THEMESFLAT_LINK . 'js/parallax_animation.min.js', array( 'jquery' ), '2.6.0', true );
	// wp_enqueue_script( 'parallax-animation', THEMESFLAT_LINK . 'js/parallax_animation.js', array( 'jquery' ), '2.6.0', true );
	...
	wp_enqueue_script( 'themesflat-core', THEMESFLAT_LINK . 'js/core.js', array(), '1.0.0', true );
...
require_once( THEMESFLAT_DIR . 'inc/options/controls/separation.php' );
