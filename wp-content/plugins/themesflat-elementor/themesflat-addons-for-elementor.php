...
final class ThemesFlat_Addon_For_Elementor_Fungi {
	...
	public function __construct() {
		...
		define( 'TF_ABSPATH', plugin_dir_path( __FILE__ ) );
		define( 'TF_TEMPLATE_DEBUG_MODE', false );
	...
	public function init() {
		...
		// require_once plugin_dir_path( __FILE__ ) . 'tf-animation.php';
		...
		add_action( 'elementor/element/section/section_layout/before_section_end', [
			$this,
			'tf_add_section_animation'
		] );
		// add_action( 'elementor/element/column/section_layout/before_section_end', [
		// 	$this,
		// 	'tf_add_section_animation'
		// ] );
		// add_action( 'elementor/element/container/section_layout/before_section_end', [
		// 	$this,
		// 	'tf_add_section_animation'
		// ] );
		// add_action( 'elementor/element/common/section_layout/before_section_end', [
		// 	$this,
		// 	'tf_add_section_animation'
		// ] );
		// add_action( 'elementor/frontend/section/before_render', [ $this, 'tf_render_section_animation' ] );
	...
	public function init_widgets() {
		...
		require_once( __DIR__ . '/widgets/widget-adv-video.php' );
		\Elementor\Plugin::instance()->widgets_manager->register( new \TF_Adv_Video_Widget() );
		...
		require_once( __DIR__ . '/widgets/widget-portfolio-grid.php' );
		\Elementor\Plugin::instance()->widgets_manager->register( new \TFPortfolioGrid_Widget() );

//		require_once( __DIR__ . '/widgets/widget-portfolio-metro.php' );
//		\Elementor\Plugin::instance()->widgets_manager->register( new \TFPortfolioMetro_Widget() );
//
//		require_once( __DIR__ . '/widgets/widget-services.php' );
//		\Elementor\Plugin::instance()->widgets_manager->register( new \TFServices_Widget() );

		require_once( __DIR__ . '/widgets/widget-heading.php' );
		\Elementor\Plugin::instance()->widgets_manager->register( new \TFHeading_Widget() );

		require_once( __DIR__ . '/widgets/widget-team-slider.php' );
		\Elementor\Plugin::instance()->widgets_manager->register( new \TFTeamSlider_Widget() );

		require_once( __DIR__ . '/widgets/widget-team-grid.php' );
		\Elementor\Plugin::instance()->widgets_manager->register( new \TFTeamGrid_Widget() );

		require_once( __DIR__ . '/widgets/widget-fancy-text.php' );
		\Elementor\Plugin::instance()->widgets_manager->register( new \TFFancy_text_Widget() );

		require_once( __DIR__ . '/widgets/widget-parallax-layer.php' );
		\Elementor\Plugin::instance()->widgets_manager->register( new \TFParallax_layer_text_Widget() );

		require_once( __DIR__ . '/widgets/widget-animation-layer.php' );
		\Elementor\Plugin::instance()->widgets_manager->register( new \TFAnimation_Layer_Widget() );

		require_once( __DIR__ . '/widgets/widget-banner.php' );
		\Elementor\Plugin::instance()->widgets_manager->register( new \TFBanner_Widget() );

		require_once( __DIR__ . '/widgets/widget-step.php' );
		\Elementor\Plugin::instance()->widgets_manager->register( new \TFStep_Widget() );

//		require_once( __DIR__ . '/widgets/widget-portfolio-slider.php' );
//		\Elementor\Plugin::instance()->widgets_manager->register( new \TFPortfolioSlider_Widget() );
	}
	...
	public function widget_styles() {
		...
		//widget
		wp_register_style( 'tf-heading', plugins_url( '/assets/css/heading/heading.css', __FILE__ ) );
		...
		wp_register_style( 'tf-adv-video', plugins_url( '/assets/css/adv-video/adv-video.css', __FILE__ ) );
		wp_register_style( 'tf-latest-blog', plugins_url( '/assets/css/latest-blog/latest-blog.css', __FILE__ ) );
		wp_register_style( 'tf-fancy-text', plugins_url( '/assets/css/fancy-text/fancy-text.css', __FILE__ ) );
		wp_register_style( 'tf-parallax-layer', plugins_url( '/assets/css/parallax-layer/parallax-layer.css', __FILE__ ) );
		wp_register_style( 'tf-animation-layer', plugins_url( '/assets/css/animation-layer/animation-layer.css', __FILE__ ) );
	...
	public function widget_scripts() {
		...
		wp_register_script( 'textition-script', plugins_url( '/assets/vendor/textition/js/textition.js', __FILE__ ), [ 'jquery' ], false, true );
		wp_register_script( 'typer-script', plugins_url( '/assets/vendor/typer/js/typer.js', __FILE__ ), [ 'jquery' ], false, true );
		wp_register_script( 'vanilla-script', plugins_url( '/assets/vendor/vanilla/js/vanilla-tilt.min.js', __FILE__ ), array(), false, true );
		wp_register_script( 'particles-script', plugins_url( '/assets/vendor/particles/js/particles.js', __FILE__ ), [ 'jquery' ], false, true );
		wp_register_script( 'mgglitch-script', plugins_url( '/assets/vendor/mgglitch/js/mgGlitch.min.js', __FILE__ ), [ 'jquery' ], false, true );


		//widget
		wp_register_script( 'tf-counter', plugins_url( '/assets/js/counter/tf-counter.js', __FILE__ ), [ 'jquery' ], false, true );
		wp_register_script( 'tf-fancy-text', plugins_url( '/assets/js/fancy-text/fancy-text.js', __FILE__ ), [ 'jquery' ], false, true );
		wp_register_script( 'tf-parallax-layer', plugins_url( '/assets/js/parallax-layer/parallax-layer.js', __FILE__ ), [ 'jquery' ], false, true );
		wp_register_script( 'tf-animation-layer', plugins_url( '/assets/js/animation-layer/animation-layer.js', __FILE__ ), [ 'jquery' ], false, true );
		...
		wp_register_script( 'tf-adv-video', plugins_url( '/assets/js/adv-video/adv-video.js', __FILE__ ), [ 'jquery' ], false, true );
		...
		wp_register_script( 'tf-services', plugins_url( '/assets/js/services/services.js', __FILE__ ), [ 'jquery' ], false, true );
		wp_register_script( 'tf-team-member', plugins_url( '/assets/js/team-member/team-member.js', __FILE__ ), [ 'jquery' ], false, true );
		wp_register_script( 'tf-iconbox', plugins_url( '/assets/js/icon-box/icon-box.js', __FILE__ ), [ 'jquery' ], false, true );


		$ajax_url = admin_url( 'admin-ajax.php' );
		wp_localize_script( 'tf-portfolio', 'ajaxAdminUrl', array(
			'url' => $ajax_url
		) );
	}
	...
	public static function get_template_id( $type ) {
		...
		$tfhf_templates = ThemesFlat_Addon_For_Elementor_Fungi::instance()->get_posts_by_conditions( 'tf_header_footer', $option );
	...
	// Animation
	public function tf_add_section_animation( \Elementor\Element_Section $section ) {
		$section->add_control(
			'h_tf_section_animation',
			[
				'label'     => esc_html__( 'TF Animation', 'themesflat-elementor' ),
				'type'      => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		// 		'label_on'     => esc_html__( 'On', 'themesflat-elementor' ),
		// 		'default'      => 'no',
		// 		'prefix_class' => 'tf-animation-',
		// 	]
		// );
		$section->add_control(
			'tf_position_animation',
			[
				'label'       => esc_html__( 'Position', 'themesflat-elementor' ),
				'type'        => \Elementor\Controls_Manager::SELECT,
				'description' => esc_html__( 'This is analogous to the background-position css property. Specify coordinates as top, bottom, right, left, center, or pixel values (e.g. -10px 0px). The animation image will be positioned as close to these values as possible while still covering the target element.', 'themesflat-elementor' ),
				'default'     => '',
				'options'     => [
					''              => esc_html__( 'Default', 'themesflat-elementor' ),
					'center center' => esc_html__( 'Center Center', 'themesflat-elementor' ),
				...
				'condition'   => [
					'tf_section_animation' => 'yes'
				],
			]
		);
		$section->add_control(
			'tf_position_animation_x',
			[
				'label'      => esc_html__( 'X Position', 'themesflat-elementor' ),
				'type'       => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				...
				'condition'  => [
					'tf_section_animation'  => 'yes',
					'tf_position_animation' => 'custom',
				],
			]
		);
		$section->add_control(
			'tf_position_animation_y',
			[
				'label'      => esc_html__( 'Y Position', 'themesflat-elementor' ),
				'type'       => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
		...
		$section->add_control(
			...
			[
				'label'       => esc_html__( 'Speed', 'themesflat-elementor' ),
				'type'        => \Elementor\Controls_Manager::SLIDER,
				'description' => esc_html__( 'The speed at which the animation effect runs. 0 means the image will appear fixed in place, and 1 the image will flow at the same speed as the page content.', 'themesflat-elementor' ),
				'size_units'  => [ 'px' ],
				'range'       => [
					'px' => [
						'min'  => 0,
		...
		$section->add_control(
			...
			[
				'label'       => esc_html__( 'Bleed', 'themesflat-elementor' ),
				'type'        => \Elementor\Controls_Manager::NUMBER,
				'description' => esc_html__( 'You can optionally set the animation mirror element to extend a few pixels above and below the mirrored element. This can hide slow or stuttering scroll events in certain browsers.', 'themesflat-elementor' ),
				'min'         => 0,
				'condition'   => [
					'tf_section_animation' => 'yes',
				],
	...
	public function tf_render_section_animation( \Elementor\Element_Base $element ) {
		if ( 'section' === $element->get_name() ) {
			// if ( 'yes' === $element->get_settings_for_display( 'tf_section_animation' ) ) {
				...
				$tf_position_animation = $element->get_settings_for_display( 'tf_position_animation' );
				if ( $tf_position_animation == 'custom' ) {
					$tf_position_animation_x = $element->get_settings_for_display( 'tf_position_animation_x' );
					$tf_position_animation_x = $tf_position_animation_x['size'];
					$tf_position_animation_y = $element->get_settings_for_display( 'tf_position_animation_y' );
					$tf_position_animation_y = $tf_position_animation_y['size'];
					$element->add_render_attribute( '_wrapper', [
						'data-positionX' => $tf_position_animation_x,
						'data-positionY' => $tf_position_animation_y,
					] );
				} else {
					$element->add_render_attribute( '_wrapper', [
						'data-position' => $tf_position_animation,
					] );
				}

				$tf_speed_animation = $element->get_settings_for_display( 'tf_speed_animation' );
				$tf_speed_animation = $tf_speed_animation['size'];
				$element->add_render_attribute( '_wrapper', [
					'data-speed' => $tf_speed_animation,
				] );

				$tf_bleed_animation = $element->get_settings_for_display( 'tf_bleed_animation' );
				if ( $tf_bleed_animation ) {
					$element->add_render_attribute( '_wrapper', [
						'data-bleed' => $tf_bleed_animation,
					] );
				}
			// }
		}
...
ThemesFlat_Addon_For_Elementor_Fungi::instance();