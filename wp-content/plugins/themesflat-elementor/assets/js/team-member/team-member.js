;(function ($) {
	...
	var tfTeamMember = function ($scope, $) {
		var owl_carousel = $scope.find(".tf-team-slider");
		var option = {};
		var options_default = {
			slidesToScroll: 1,
			slidesToShow: 1,
	...
	$(window).on('elementor/frontend/init', function () {
		elementorFrontend.hooks.addAction('frontend/element_ready/tf-team-slider.default', tfTeamMember);
	});
