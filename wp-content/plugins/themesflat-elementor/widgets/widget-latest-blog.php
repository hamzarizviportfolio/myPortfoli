...
class TFLatest_Blog_Widget extends \Elementor\Widget_Base {
	...
	protected function register_style_wrap() {
		...
		$this->add_control(
			'border_color',
			[
				'label' => esc_html__('Separator Color', 'themesflat-elementor'),
	...
	protected function register_style_title() {
		...
		$this->add_control(
			'title_color_hover',
			[
				'label' => esc_html__('title Color Hover', 'themesflat-elementor'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
	...
	protected function register_style_read_more() {
		...
		$this->add_control(
			'read_more_color',
			[
				'label' => esc_html__('Read More Color', 'themesflat-elementor'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Read More Color Hover', 'themesflat-elementor'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
