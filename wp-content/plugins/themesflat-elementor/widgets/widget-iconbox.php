...
class TFIconBox_Widget extends \Elementor\Widget_Base {
	...
	public function get_script_depends() {
		return [ 'vanilla-script', 'tf-iconbox' ];
	}
	...
	protected function container_style() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .tficonbox .content-wrapper' => 'text-align: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label'                => esc_html__( 'Vertical Alignment', 'themesflat-elementor' ),
				'type'                 => Controls_Manager::SELECT,
				'options'              => [
					'top'    => esc_html__( 'Top', 'themesflat-elementor' ),
					'middle' => esc_html__( 'Middle', 'themesflat-elementor' ),
				...
				'selectors'            => [
					'{{WRAPPER}} .tficonbox .content-wrapper' => 'align-items: {{VALUE}};',
				],
				'condition'            => [
					'position!' => 'top',
				],
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
					'{{WRAPPER}} .tficonbox .content-wrapper' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
					'{{WRAPPER}} .tficonbox .content-wrapper' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .tficonbox .content-wrapper',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em' ],
				'selectors'  => [
					'{{WRAPPER}} .tficonbox .content-wrapper'        => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .tficonbox.hover-style-01::&:after' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => esc_html__( 'Background', 'themesflat-elementor' ),
				'types'    => [ 'classic', 'gradient' ],
				'selector' => '{{WRAPPER}} .tficonbox:hover .content-wrapper',
			]
		);
	...
	protected function icon_style() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em' ],
				'selectors'  => [
					'{{WRAPPER}} .tficonbox .wrap-icon-inner' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'label'     => esc_html__( 'Background', 'themesflat-elementor' ),
				'types'     => [ 'classic', 'gradient' ],
				'selector'  => '{{WRAPPER}} .tficonbox:hover .wrap-icon.circle .wrap-icon-inner, {{WRAPPER}} .tficonbox:hover .wrap-icon.square .wrap-icon-inner, {{WRAPPER}} .tficonbox:hover .wrap-icon-spin-around:before,{{WRAPPER}} .tficonbox.hover-style-02:hover::after',
				'condition' => [
					'icon_showcase' => [ 'circle', 'square' ]
				]
			]
		...
		$this->add_control(
			...
			[
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .tficonbox:hover .wrap-icon.circle-outline .wrap-icon-inner, {{WRAPPER}} .tficonbox:hover .wrap-icon.square-outline .wrap-icon-inner, {{WRAPPER}} .tficonbox:hover .wrap-icon-spin-around:before,{{WRAPPER}} .tficonbox.hover-style-02:after' => 'border-color: {{VALUE}}', 
	...
	protected function content_style() {
		...
		$this->add_control(
			...
			[
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .tficonbox .content .title' => 'color: {{VALUE}};',
				],
			]
		);
	...
	protected function render( $instance = [] ) {
		...
		$this->add_render_attribute( 'tf_iconbox', [
			'class' => [
				'tficonbox',
				'hover-' . $settings['hover_style'],
				$settings['position']
			],
		] );
		if ( $settings['hover_style'] == 'style-02' ) {
			$this->add_render_attribute( 'tf_iconbox_content', [
				'data-tilt'     => '',
				'data-tilt-max' => 15
			] );
		}
		...
		?>
        <div <?php echo $this->get_render_attribute_string( 'tf_iconbox' ) ?>>
            <div class="content-wrapper" <?php echo $this->get_render_attribute_string( 'tf_iconbox_content' ) ?>>
