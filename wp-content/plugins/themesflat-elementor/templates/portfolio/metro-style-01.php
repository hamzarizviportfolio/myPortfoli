 ...
 */
?>
<div class="<?php echo esc_attr( $settings['column_class'] ) ?>" style="">
		...
		<?php if ( has_post_thumbnail()) : ?>
            <div class="featured-post">
                <a class="tf-entry-portfolio-thumb" href="<?php echo esc_url( get_the_permalink() ) ?>"
                   style="background-image: url('<?php echo esc_url( wp_get_attachment_image_url( get_post_thumbnail_id(), 'full' ) ) ?>');<?php echo esc_attr( $settings['style'] ) ?>">
                </a>
